...
import static offgrid.geogram.old.bluetooth_old.other.comms.BlueCommands.oneLineAcknowledgement;
import static offgrid.geogram.old.bluetooth_old.other.comms.BlueCommands.oneLineCommandBio;
import static offgrid.geogram.old.bluetooth_old.other.comms.BlueCommands.oneLineCommandGapBroadcast;
import static offgrid.geogram.old.bluetooth_old.other.comms.BlueCommands.gapREPEAT;
import static offgrid.geogram.old.bluetooth_old.other.comms.BlueCommands.oneLineCommandPing;
...
public class BlueReceiver {
    ...
    public void receivingDataFromDevice(String macAddress, String receivedData, Context context) {
        ...
        if(packageBeingReceived.allParcelsReceivedAndValid()){
            ...
            EventControl.startEvent(EventType.BLUETOOTH_MESSAGE_RECEIVED, packageBeingReceived);
        }
